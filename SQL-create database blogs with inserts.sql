...
(
	...
	CONSTRAINT DATE_VALID_POST CHECK(post_date >= GETDATE())
)
...
(
	...
	CONSTRAINT DATE_VALID_COMMENT CHECK(comment_date >= GETDATE())
)
...
insert into Posts(user_id, post_title, post_description, post_url, post_date, post_likes, post_disslike) values(5, 'Harry only make use time', 'If this is a legitimate option for saving people, why dont they ever use it again?' ,'https://?pharetra=mauris&magna=non&vestiis=congue&sapien=vivamus&sapien=&non=aenean&quam' , getdate(), 5,10)
insert into Posts(user_id, post_title, post_description, post_url, post_date, post_likes, post_disslike) values(2, 'Why the Sense self-aware?',	'How do the differences between Deckard and the replicants.tarts off  emotionless as the replicants.', 'http://?consectetuer=maecenas&dmain=jljlj&jkj', getdate(), 54, 7 )
insert into Posts(user_id, post_title, post_description, post_url, post_date, post_likes, post_disslike) values(2, 'name who eating stuff?', 'was released only very recently. But every now and then scenes set backstage at the Muppet Theatre' ,	'http://?montes=est&nascetur=et&ridiculus=tempus&mus=semper&vivamus=est&vestibulum=quam&sagittisus&', getdate(), 4,10)
insert into Posts(user_id, post_title, post_description, post_url, post_date, post_likes, post_disslike) values(4, 'difference between houses',	'replicant detection occurs via the subjects ability inability to show advanced emotion.', 'http://?scelerisque=magnis&mauris=dis&sit=parturient&amet=montes&eros=nascet&duis==end=cras&=vul', getdate(), 5,9)
insert into Posts(user_id, post_title, post_description, post_url, post_date, post_likes, post_disslike) values(7, 'What origin of Persephone',	'As shown in the movie Persephone was the wife of The Merovingian,who himself was an obsolete program'	,'https://?donec=pretium&odio=nisl&justo=ut&sollicitudin=volutpat&ut=sapien&suscipit=arcu&a=pat&acium', getdate(), 23,5)
insert into Posts(user_id, post_title, post_description, post_url, post_date, post_likes, post_disslike) values(7, 'How is ending Collateral?',	'Heres what happens at the end of Should we accept this as a', 'http://?tristique=nisl&est=nunc&et=nisl&tempus=duis&semper=bibendum&est=felis&quammassa&inlum&nu', getdate(), 6,15)
insert into Posts(user_id, post_title, post_description, post_url, post_date, post_likes, post_disslike) values(8, 'Social Network class' , 'which class is Mark when he falls asleep? answers the question.it might be Computer Architecture.' ,'http://?enim=morbi&blandit=non&mi=quam&in=nec&porttitor=dui&pede=luctus&justo=rutrum&eu=&at=vel&ven', getdate(), 65,9)
insert into Posts(user_id, post_title, post_description, post_url, post_date, post_likes, post_disslike) values(10, 'in the Daniel  movies	T','he most recent installments of featuring Daniel Craig have fewer gadgets but more raw action like' ,	'https://?mi=varius&in=nulla&porttitor=facilisi&pede=cras&justo=non&eu=velit&massa=nec&donec=nisi&ve', getdate(), 65,9)
insert into Posts(user_id, post_title, post_description, post_url, post_date, post_likes, post_disslike) values(16, 'write instead Carpenter?',	'There is something I always found odd about the soundtrack of Johns 1982 version'	,'https://?phasellus=dui&sit=nec&amet=nisi&erat=volutpat&nulla=eleifend&tempus=donec&vivamus=ut&in=do', getdate(), 65,9)
insert into Posts(user_id, post_title, post_description, post_url, post_date, post_likes, post_disslike) values(16, 'What layer Dream May Come', 'What Dreams May Come Robin Williams character Chris Nielsen travels through hell.',	'https://?dis=sed&parturient=lacus&montes=morbi&nascetur=sem&ridiculus=mauris&mus=laoreet&etiamahoncu', getdate(), 65,9)
insert into Posts(user_id, post_title, post_description, post_url, post_date, post_likes, post_disslike) values(12, 'What is Harveys purpose?'	,'Apparently he has chosen Elwood, Dowd as some sort of medium to make people aware of him and contact',	'https://?est=sed&donec=magna&odio=at&justo=nunc&sollicitudin=commodo&ut=placerat&suscipit=ngede&diam', getdate(), 65,9)
insert into Posts(user_id, post_title, post_description, post_url, post_date, post_likes, post_disslike) values(16, 'the opening break scene', 'Mark and Erica talking about knowledge of people in China, and Marks  with getting into the Club.'	,'http://?turpis=eget&donec=eros&posuere=elementum&metus=pellentesque&vitae=quisque&ipsum=porta&aliqua', getdate(), 65,9)
insert into Posts(user_id, post_title, post_description, post_url, post_date, post_likes, post_disslike) values(13, 'Movie about army soldiers', 'I am trying to remember the name of a movie where there is a group of soldiers from the reserve', 'http://?eu=dolor&est=vel&congue=est&elementum=donec&in=odio&hac=justo&habitasse=sollicitudin&platea', getdate(), 65,9)
insert into Posts(user_id, post_title, post_description, post_url, post_date, post_likes, post_disslike) values(16, 'Spirits of the Past ideas','Spirits of the Past Toola at the beginning receives a phonecall which she doesnt end up ',	'https://?tellus=morbi&nisi=non&eu=lectus&orci=aliquam&mauris=sit&lacinia=amet&sapien=diam&q', getdate(), 65,9)
insert into Posts(user_id, post_title, post_description, post_url, post_date, post_likes, post_disslike) values(16, 'Ending Social Network' ,	'At the start Erica tells Mark But youre going to go through life thinking that girls dont like you', 'http://?duis=pretium&ac=quis&nibh=lectus&fusce=suspendisse&lacus=potenti&purus=in&aliquet=eleifend&a', getdate(), 65,9)
insert into Posts(user_id, post_title, post_description, post_url, post_date, post_likes, post_disslike) values(16, 'character Operat Systems',	 'He then storms out and answers the professors question accurately.',	'https://?elit=integer&ac=a&nulla=nibh&sed=in&vel=quis&enim=justo&sit=maecenas&amet=rhoncus&nunc=ali', getdate(), 65,9)
insert into Posts(user_id, post_title, post_description, post_url, post_date, post_likes, post_disslike) values(18, 'scene ending represent','What does this scene depict? How does it relate to the movie?',	'https://?in=dolor&faucibus=morbi&orci=vel&luctus=lectus&et=in&ultrices=quam&posuere=fringilla&cubil', getdate(), 65,9)
insert into Posts(user_id, post_title, post_description, post_url, post_date, post_likes, post_disslike) values(16, 'What detail looking for', 	'I understand that Leonard Shelby has amnesia which makes him unable to keep new memories.', 'http://?mauris=sociis&lacinia=natoque&sapien=penatibus&quis=et&libero=magnis&nullam=dis&sit=par', getdate(), 65,9)
insert into Posts(user_id, post_title, post_description, post_url, post_date, post_likes, post_disslike) values(11, 'Snow based off real film?' , 'The movie was set in Santas workshop, and featured Christmas hobgoblins and Little Bo Peep.', 	'https://?non=felis&pretium=sed&quis=lacus&lectus=morbi&suspendisse=sem&potenti=mauris&in=laoreet&ele', getdate(), 65,9)
insert into Posts(user_id, post_title, post_description, post_url, post_date, post_likes, post_disslike) values(16, 'Explanation end monolog',	'in the name of charity and good will, shepherds the weak through the valley of the darkness.',	'https://?ultrices=ipsum&erat=integer&tortor=a&sollicitudin=nibh&mi=in&sit=quis&amet=justo&lobortis=', getdate(), 65,9)
insert into Posts(user_id, post_title, post_description, post_url, post_date, post_likes, post_disslike) values(16, 'Dragon Tattoo', 'What the unique point for this teaser within those three months before the trailer was released?', 	'https://?tempus=aliquam&sit=sit&amet=amet&sem=diam&fusce=in&consequat=magna&nulla=bibendum&nisl', getdate(), 65,9)
insert into Posts(user_id, post_title, post_description, post_url, post_date, post_likes, post_disslike) values(11, 'Why the reflection match?','Stevens looks in the train bathroom mirror and sees Sean Fentress, a teacher', 'http://?mattis=at&egestas=vulputate&metus=vitae&aenean=nisl&fermentum=aenean&donec=lectus&ut=pel', getdate(), 65,9)
insert into Posts(user_id, post_title, post_description, post_url, post_date, post_likes, post_disslike) values(12, 'Vincents Spikes similar?','Spike is thrown off and almost dies.What Vincent and Spike share for him to say such a statement?',	'http://?orci=volutpat&luctus=quam&et=pede&ultrices=lobortis&posuere=ligula&cubilia=sit&curae=amet&d', getdate(), 65,14)
insert into Posts(user_id, post_title, post_description, post_url, post_date, post_likes, post_disslike) values(16, 'Nightmare on Elm Street?',	'A Nightmare on Elm Street</a>? Does <em>Elm tree</em> represent something bad in the horror context?',	'https://?amet=diam&consectetuer=neque&adipiscing=vestibulum&elit=eget&proin=vulputate&interdum=u', getdate(), 624,4)
insert into Posts(user_id, post_title, post_description, post_url, post_date, post_likes, post_disslike) values(16, 'What happened to the last','Wrath and Pride.And also is the scene in which the head of a woman (detectives wife?',	'http://?sollicitudin=in&ut=sagittis&suscipit=dui&a=vel&feugiat=nisl&et=duis&eros=ac&vestibulum=nibh&', getdate(), 30,9)
insert into Posts(user_id, post_title, post_description, post_url, post_date, post_likes, post_disslike) values(17, 'ages switched in the film','His casting led Spielberg to reverse the ages of the children.Is that the only reason?',	'https://?vivamus=eu&vel=est&nulla=congue&eget=elementum&eros=in&elementum=hac&pellentesque=habitass', getdate(), 20,13)
insert into Posts(user_id, post_title, post_description, post_url, post_date, post_likes, post_disslike) values(20, 'What significance does it','In the Coen brothers,movie the detective Marge Gunderson gets called by and meets an old schoolmate','https://?sed=cubilia&interdum=curae', getdate(), 1,90)
